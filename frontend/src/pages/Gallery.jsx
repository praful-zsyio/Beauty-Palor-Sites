...
const salonPhotos = [
    "/images/hero_salon.jpg",
    "/images/bridal_makeover.jpg",
    "/images/facial_glow.jpg",
...
const galleryItems = [
    { id: 1, category: 'Bridal', title: 'Royal Bridal Look', emoji: '👰', color: '#fef9e7' },
    { id: 2, category: 'Hair', title: 'Balayage Highlights', emoji: '💇', color: '#fff5f5' },
    { id: 3, category: 'Makeup', title: 'Party Glam Makeup', emoji: '💄', color: '#ffebee' },
    ...
    { id: 7, category: 'Hair', title: 'Keratin Treatment', emoji: '💇', color: '#fff5f5' },
    { id: 8, category: 'Makeup', title: 'Engagement Makeup', emoji: '💍', color: '#ffebee' },
    ...
    { id: 12, category: 'Hair', title: 'Hair Coloring', emoji: '🎨', color: '#fff5f5' },
];
...
export default function Gallery() {
    ...
    return (
        <div>
            <Helmet>
                <title>Gallery | Shivani Beauty Palor &amp; Academy</title>
                <meta name="description" content="Browse our stunning portfolio of bridal looks, hair transformations, makeup artistry, and nail designs at Shivani Beauty Palor & Academy, Pithampur." />
            </Helmet>
            ...
            <section className="salon-photos-section">
                <div className="container">
                    ...
                    >
                        <div className="section-label" style={{ justifyContent: 'center' }}>Inside Our Sanctuary</div>
                        <h2 className="section-title">Shivani Beauty Palor <span className="text-gradient">Showcase</span></h2>
                        <p style={{ color: 'var(--slate)', maxWidth: '520px', margin: '0.75rem auto 0' }}>
                            Step inside Shivani Beauty Palor &amp; Academy — where every corner is crafted for your comfort, luxury, and beauty.
                        </p>
                    </motion.div>
                    ...
                    <div className="salon-photo-grid">
                        {salonPhotos.map((src, index) => (
                            ...
                            >
                                <img src={src} alt={`Shivani Beauty Palor - Photo ${index + 1}`} loading="lazy" />
